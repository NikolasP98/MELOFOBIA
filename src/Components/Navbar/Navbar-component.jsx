...
import { SwipeableDrawer, List, ListItem, ListItemText, Divider, AppBar, Toolbar, Button, IconButton, Typography } from '@material-ui/core';
        ...
        >
          ...
          >
            ...
            <List className='list-container'>
              ...
              <ListItem button className='list-item'>
                <ListItemText primary='Second Item' className='list-item-text' />
              </ListItem>
              <ListItem button className='list-item'>
