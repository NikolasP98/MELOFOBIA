...
function Article() {
    return (
        <div className="articles">
            <div className="back-btn"><ArrowBackIcon style={{ fontSize: 32 }} />Back</div>
            ...
            <div className="main">
                ...
                <div>
                    <div className="article-main">
                        ...
                        <div>
                            <button className="btn btn-play-list"><PlayArrowIcon />Listen to Playlist</button>
                        </div>
                        <div className="article-main-main">
                            ...
                            <div className="article-link">
                                ...
                                <div className="article-link-content">
                                    <p>
                                        Nulla lacus purus, tincidunt ac
                                        consectetur id, porttitor nec ex.
                                        In id nisi id purus iaculis
                                        posuere. Mauris sit amet nisi
                                        vitae felis porta venenatis at at
                                        justo. Nulla vel vehicula nulla.
                                        Nullam mattis fringilla ante
                                        auctor iaculis. Aliquam posuere
                                        in purus eu accumsan. Nullam
                                        cursus tellus non ex elementum,
                                        nec rutrum dui ultrices. Cras
                                        pharetra et quam id vulputate.
                                        Vestibulum pharetra, tellus vel
                                        malesuada lobortis, purus turpis
                                        cursus ipsum, id placerat velit
                                        ex volutpat elit. Integer vel
                                        ligula a diam gravida malesuada.
                                        Donec imperdiet justo sed dolor
                                        fringilla, quis ullamcorper urna
                                        condimentum.
                            </p>
                                </div>
                            </div>
                            <div className="article-link">
                                ...
                                <div className="article-link-content">
                                    <p>
                                        Vivamus tincidunt tincidunt nibh,
                                        nec consequat nisi cursus ut.
                                        Praesent imperdiet ultrices
                                        scelerisque. Pellentesque aliquam
                                        placerat accumsan. Fusce
                                        fringilla mauris eu mauris
                                        aliquet facilisis. Praesent
                                        elementum augue in arcu eleifend,
                                        quis sagittis sapien tincidunt.
                                        Phasellus vitae est fermentum,
                                        accumsan arcu ut, elementum
                                        felis. Sed non ex gravida,
                                        viverra odio non, rutrum ante.
                                        Proin id quam feugiat, fringilla
                                        elit id, efficitur ipsum. Sed
                                        tellus nibh, commodo ac hendrerit
                                        ullamcorper, aliquet id purus.
                                        Phasellus lorem augue, iaculis
                                        quis lacus nec, iaculis mollis
                                        erat.
                            </p>
                                </div>
                            </div>
                    ...
                    <div className="discussion-playlist">
                        <div className="discussion">
                            ...
                            <div className="discussion-desktop">
